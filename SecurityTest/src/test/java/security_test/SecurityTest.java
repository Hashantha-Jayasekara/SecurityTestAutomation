...
/**
 * Created by Hashantha on 5/31/2016.
 */
...
public class SecurityTest {
    ...
    private String site = "http://localhost:8081/bodgeit/";
  ...
  public  void testMenu(){
    ...
    private void checkMenu(String linkText, String page) {
    ...
    private void checkMenuLinks(String page) {
    ...
    public  void  tstRegisterAndLoginUser(){
        //create random user name so we can rerun  test
    ...
    public  void tstSearch(){
        driver.get(site + "search.jsp?q=do");
        sleep();
    }
